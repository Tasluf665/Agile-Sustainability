...
- Add a `docker-compose` example with env file template.
- Add a developer quickstart `Makefile` or npm script collection.
- Generate API documentation (OpenAPI/Swagger) from the existing routes.

Updated `README.md`. See [README.md](README.md) for details.
